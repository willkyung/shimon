    ...
    return WorkSessionData(
        ...
        active_rest=(
            ActiveRestData(
                ...
                rest_type=active_rest.rest_type,
...
def start_work_session(
    ...
    work_session = WorkSession(
        ...
        work_type=profile.work_type or request.work_type,
        work_intensity=profile.work_intensity or request.work_intensity,
...
def start_rest(
    ...
    rest_type = RestType.LEGAL_REQUIRED if is_legal else RestType.AI_RECOMMENDED if is_ai_high else RestType.SELF_INITIATED
